...
const Components = {
    ...
    <div class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50 md:hidden safe-area-bottom">
        <div class="flex">
            <a href="tel:0800452104" class="flex-1 flex items-center justify-center gap-2 bg-navy text-white py-4 font-semibold">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                </svg>
                Call Now
    ...
    <footer class="bg-navy-dark text-white py-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-400">
                        ...
                        <li class="flex items-start gap-2 mt-2">
                            ...
                            180 Fred Taylor Drive,<br>Whenuapai, Auckland 0814
                        </li>
                    </ul>
            ...
            <div class="border-t border-gray-700 mt-8 pt-6 text-center text-gray-500 text-sm">
                <p>&copy; 2026 Xpert Junk Removal. All rights reserved.</p>
            </div>
        </div>
    </footer>`,
    ...
    init: function() {
        ...
        document.body.insertAdjacentHTML('beforeend', this.stickyCTA);

        // Add bottom padding to body for sticky CTA on mobile
